...
namespace HajHakathon
{
    public static class HtmlHelperExtensions
    {
        ...
        public static IHtmlString RouteIf(this HtmlHelper helper, string value, string Rvalue, string attribute)
        {
            ...
            var hasController = Rvalue.Equals(currentController, StringComparison.InvariantCultureIgnoreCase);
            var hasAction = value.Equals(currentAction, StringComparison.InvariantCultureIgnoreCase);

            return (hasAction && hasController) || (hasController) ? new HtmlString(attribute) : new HtmlString(string.Empty);
        }
